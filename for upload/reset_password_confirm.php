    ...
    if (!preg_match('/^[a-f0-9]{64}$/', $token)) {
        ...
        if (!check_reset_attempt_limit($ip_address)) {
            ...
            try {
                ...
                // Verify token exists, hasn't expired, and user is active
                $stmt = $pdo->prepare("
                    SELECT 
                        u.id, 
                        u.email, 
        ...
        <div class="reset-form border rounded p-4 shadow">
            ...
            <?php if (!empty($error)): ?>
                <div class="alert alert-danger" role="alert">
                    ...
                    <?php echo $error; // Already sanitized or from controlled source ?>
                </div>
            ...
            <?php if (!empty($success)): ?>
                ...
                <div class="alert alert-info" role="alert">
                    ...
                    <ul class="mb-0 mt-2">
                        <li>All other sessions have been terminated for security</li>
