        ...
        if (!check_registration_rate_limit($ip_address, $email)) {
            ...
            if (empty($diocese) || empty($archdeaconry) || empty($deanery) || empty($parish)) {
                ...
                if (!empty($password_errors)) {
                    ...
                    debug_log("Diocese: {$diocese}, Archdeaconry: {$archdeaconry}, Deanery: {$deanery}, Parish: {$parish}");
                    debug_log("User: {$first_name} {$last_name} ({$email})");
                    ...
                    try {
                        ...
                        if (!$dioceseData) {
                            debug_log("ERROR: Diocese data not found");
                        ...
                        debug_log("Validation - Arch: {$archdeaconryFound}, Dean: {$deaneryFound}, Parish: {$parishFound}");
                        ...
                        if (!$diocese_id) {
                            ...
                            debug_log("Created diocese ID: {$diocese_id}");
                        } else {
                            debug_log("Found diocese ID: {$diocese_id}");
                        }
                        ...
                        if (!$archdeaconry_id) {
                            ...
                            debug_log("Created archdeaconry ID: {$archdeaconry_id}");
                        } else {
                            debug_log("Found archdeaconry ID: {$archdeaconry_id}");
                        }
                        ...
                        if (!$deanery_id) {
                            ...
                            debug_log("Created deanery ID: {$deanery_id}");
                        } else {
                            debug_log("Found deanery ID: {$deanery_id}");
                        }
                        ...
                        if (!$parish_id) {
                            ...
                            debug_log("Created parish ID: {$parish_id}");
                        } else {
                            debug_log("Found parish ID: {$parish_id}");
                        }
                        
                        debug_log("IDs - Diocese: {$diocese_id}, Arch: {$archdeaconry_id}, Dean: {$deanery_id}, Parish: {$parish_id}");
                        ...
                        if (!$org) {
                            ...
                            debug_log("Created organization ID: {$org_id}");
                        } else {
                            $org_id = $org['id'];
                            debug_log("Found organization ID: {$org_id}");
                        }
                        ...
                        if ($username_exists || $email_exists) {
                            debug_log("ERROR: Duplicate username or email");
                        ...
                        debug_log("=== REGISTRATION COMPLETED ===\n\n");
